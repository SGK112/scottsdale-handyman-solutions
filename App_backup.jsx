...
function App() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      type: 'bot',
      message: 'Hi! I\'m your virtual handyman assistant. How can I help you today?',
      timestamp: new Date()
    }
  ])
  ...
  const chatbotResponses = {
    greetings: [
      "Hello! I'm here to help with your handyman needs. What can I assist you with?",
      "Hi there! I'm your virtual handyman assistant. How can I help you today?",
      "Welcome! I can help answer questions about our services. What would you like to know?"
    ],
    services: {
      electrical: "We provide comprehensive electrical services including outlet installation, fixture replacement, circuit repairs, ceiling fan installation, and electrical safety inspections. All work is performed by licensed electricians.",
      plumbing: "Our plumbing services include leak repairs, faucet installation, toilet repairs, drain cleaning, pipe repairs, and water heater maintenance. We handle both emergency and scheduled plumbing needs.",
      painting: "We offer interior and exterior painting services including wall preparation, primer application, professional painting, and cleanup. We use high-quality paints suitable for Arizona's climate.",
      drywall: "Our drywall services include hole repairs, texture matching, crack fixing, new drywall installation, and painting preparation. We handle everything from small nail holes to large wall repairs.",
      flooring: "We install and repair various flooring types including tile, hardwood, laminate, and vinyl. We also provide floor preparation, baseboard installation, and transitions between different flooring materials.",
      hvac: "We provide HVAC maintenance including filter replacements, vent cleaning, thermostat installation, and minor repairs. For major HVAC work, we partner with licensed HVAC contractors.",
      general: "We handle all types of general handyman work including furniture assembly, shelf installation, door repairs, window maintenance, fence repairs, and home improvement projects."
    },
    pricing: "Our pricing varies by project complexity. We offer free estimates for most jobs. Typical rates range from $75-150 per hour depending on the service. Would you like me to connect you with someone for a specific quote?",
    scheduling: "We're available Monday through Saturday, 7 AM to 6 PM. Emergency services are available 24/7. You can schedule through our contact form or call (480) 255-5887. What type of service do you need?",
    emergency: "For emergency services, please call us immediately at (480) 255-5887. We provide 24/7 emergency response for urgent plumbing, electrical, and security issues.",
    location: "We proudly serve Scottsdale and the greater Phoenix metropolitan area including Paradise Valley, Tempe, Mesa, and Fountain Hills. Service area extends within 25 miles of Scottsdale.",
    contact: "You can reach us at (480) 255-5887 or email help.scottsdalehandyman@gmail.com. We typically respond to emails within 2 hours during business hours.",
    quote: "I'd be happy to help you get a quote! You can use our quote request form, call us at (480) 255-5887, or click the 'Get Free Quote' button. What type of project do you have in mind?"
  }
  ...
  const generateChatResponse = (userMessage) => {
    ...
    if (message.includes('electrical') || message.includes('electric') || message.includes('outlet') || message.includes('wiring')) {
      return chatbotResponses.services.electrical
    }
    if (message.includes('plumbing') || message.includes('leak') || message.includes('faucet') || message.includes('toilet') || message.includes('drain')) {
      return chatbotResponses.services.plumbing
    }
    if (message.includes('paint') || message.includes('painting') || message.includes('wall') || message.includes('color')) {
      return chatbotResponses.services.painting
    }
    if (message.includes('drywall') || message.includes('hole') || message.includes('crack') || message.includes('repair')) {
      return chatbotResponses.services.drywall
    }
    if (message.includes('floor') || message.includes('tile') || message.includes('hardwood') || message.includes('laminate')) {
      return chatbotResponses.services.flooring
    }
    if (message.includes('hvac') || message.includes('air') || message.includes('heating') || message.includes('cooling') || message.includes('thermostat')) {
      return chatbotResponses.services.hvac
    }
    ...
    if (message.includes('schedule') || message.includes('appointment') || message.includes('available') || message.includes('when')) {
      return chatbotResponses.scheduling
    }
    ...
    // Location questions
    if (message.includes('area') || message.includes('location') || message.includes('serve') || message.includes('where')) {
    ...
    // Quote requests
    if (message.includes('quote') || message.includes('estimate') || message.includes('free')) {
      return chatbotResponses.quote
    }
    
    // Default response
    return `I understand you're asking about "${userMessage}". I can help with information about our electrical, plumbing, painting, drywall, flooring, and general handyman services. I can also provide details about pricing, scheduling, and how to contact us. What specific service are you interested in?`
  }
  ...
  const handleChatSubmit = (e) => {
    ...
    setTimeout(() => {
      const botResponse = {
        id: Date.now() + 1,
        type: 'bot',
        message: generateChatResponse(userMessage.message),
        timestamp: new Date()
      }
        ...
        <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-80 h-96 flex flex-col">
          ...
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Bot size={20} />
              <span className="font-semibold">Handyman Assistant</span>
            </div>
              ...
              <button
                onClick={() => {
                  setChatMessages([{
                    id: 1,
                    type: 'bot',
                    message: "Hello! I'm your virtual handyman assistant. I can help answer questions about our electrical, plumbing, painting, drywall, flooring, and general repair services. What can I help you with today?",
                    timestamp: new Date()
                  }])
                }}
              ...
              >
                ...
                >
                  <div className="flex items-start gap-2">
                    {msg.type === 'bot' && <Bot size={16} className="mt-0.5 flex-shrink-0" />}
                    <span className="text-sm">{msg.message}</span>
                    {msg.type === 'user' && <User size={16} className="mt-0.5 flex-shrink-0" />}
                  </div>
                </div>
              </div>
            ))}
