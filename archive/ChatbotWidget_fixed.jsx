            ...
            {!chatOpen ? (
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {/* Enhanced Quick Replies Section */}
                        <div style={{
                            padding: '12px 16px',
                            ...
                            <div style={{
                                ...
                                {[
                                    ...
                                    { text: '💰 Get Quote', msg: 'I need a free quote for my project', color: '#10b981' },
                                    ...
                                    <button
                                        ...
                                        onMouseEnter={(e) => {
                                            ...
                                            e.target.style.boxShadow = `0 8px 20px ${suggestion.color}30`
                                        ...
                                        onMouseLeave={(e) => {
                                            ...
                                            e.target.style.borderColor = `${suggestion.color}20`
                                        }}
                                    >
                                        {suggestion.text}
                                    </button>
                            ...
                            {/* Secondary Quick Options - Scrollable Row */}
                            <div style={{
                                display: 'flex',
                                gap: '6px',
                                overflowX: 'auto',
                                ...
                                {[
                                    { text: '⏰ Hours', msg: 'What are your business hours?' },
                                    { text: '💡 Electrical', msg: 'I need electrical work done' },
                                    { text: '🚿 Plumbing', msg: 'I have a plumbing issue' },
                                    { text: '🏠 Remodeling', msg: 'I want to remodel my home' },
                                    { text: '🔐 Security', msg: 'I need security system help' }
                                ].map((suggestion, index) => (
                                    <button
                                        key={index + 4}
                                        onClick={() => {
